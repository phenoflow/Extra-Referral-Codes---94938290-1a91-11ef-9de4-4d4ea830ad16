...
(async () => {
  ...
  await fs.writeFile("extra-referral-codes-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("extra-referral-codes-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
